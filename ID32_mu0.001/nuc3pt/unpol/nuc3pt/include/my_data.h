...
Int_t Data::GetSourceLocation() const
{
    return dirNumber;
}
...
{
    TString str;
    str  = "/home/brandon/Brookhaven_Research/ID32_mu0.001/nuc3pt/unpol/nuc3pt/tsrc";
    str += dirNumber;
    str += "/nuc3pt.dat.";
    str += fileNumber;
    return str;
