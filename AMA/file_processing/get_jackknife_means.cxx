...
void get_jackknife_means()
{
    ...
    Float_t C2[nTimes][16*nFiles][2];
    Float_t C3_u[nTimes][16*nFiles][2];
    Float_t C3_d[nTimes][16*nFiles][2];

    Float_t jth_C2[nTimes][16*nFiles][2];
    Float_t jth_C3_u[nTimes][16*nFiles][2];
    Float_t jth_C3_d[nTimes][16*nFiles][2];
