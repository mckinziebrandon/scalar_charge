...
void get_jackknife_ratios()
{
    ...
    TH1F * jth_C2_hist_real[nJack];    
    TH1F * jth_C2_hist_imag[nJack];    
    TH1F * jth_C3_u_hist_real[nJack];    
    TH1F * jth_C3_u_hist_imag[nJack];    
    TH1F * jth_C3_d_hist_real[nJack];    
    TH1F * jth_C3_d_hist_imag[nJack];    
