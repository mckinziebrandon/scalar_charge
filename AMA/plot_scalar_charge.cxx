...
Int_t plot_scalar_charge()
{
    ...
    for (int t = 0; t < 8; t++)
    {
        average.SetReal(AverageOverFiles(jth_ratio_hist_real, t+1, nJack));
        average.SetImag(AverageOverFiles(jth_ratio_hist_imag, t+1, nJack));

        error.SetReal(ErrorOverFiles(jth_ratio_hist_real, t+1, nJack, average.GetReal()));
        error.SetImag(ErrorOverFiles(jth_ratio_hist_imag, t+1, nJack, average.GetImag()));
